...
public class QuestionServiceTest {
    ...
    void save(){
        ...
        //Then
        Assertions.assertThat(questionRepository.findById(question.getId())).isPresent();
    ...
    void update() {
        ...
        //When
        Question getQuestion_modify = questionService.updateQuestion(question_modify,question.getId());
...
//        }
    ...
    void delete(){
        ...
        //Then
        Assertions.assertThat(questionRepository.findById(question.getId()).isEmpty());
    }
}

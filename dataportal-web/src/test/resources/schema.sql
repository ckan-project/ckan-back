create table if not exists test.data_request
(
...
create table if not exists test.dataset_theme
(
    ...
    constraint FKgcerm44anuenpnm627hscd0gx
        foreign key (dataset_id) references test.dataset (dataset_id)
);

create table if not exists test.resource
(
    dataset_id    bigint       null,
...
create table if not exists test.download
(
    dataset_id  bigint null,
...
create table if not exists test.notice
(
...
create table if not exists test.scrap
(
    dataset_id bigint null,
